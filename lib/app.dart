...
class _HomeSection extends StatelessComponent {
        ...
        div(classes: 'hero', [
          ...
          div(classes: 'hero-content', [
            ...
            div(classes: 'hero-cta-row', [
              a(
                href:
                    'https://drive.google.com/file/d/1ZZhO_ugFV2PDxQsOrfvg69u05UKA5Qvg/view?usp=sharing',
                target: Target.blank,
                classes: 'btn-primary',
  ...
  static Component _socialIcon({
    ...
    return a(href: href, target: Target.blank, classes: 'social-icon', [
      img(src: icon, alt: label, classes: 'social-icon-img'),
    ]);
  }
}
...
class _AboutSection extends StatelessComponent {
  ...
  Component _aboutBullet(String value) {
    return li(classes: 'about-bullet', [
  ...
  Component _statCard(String value, String label) {
    return div(classes: 'stat-card', [
      h4(classes: 'stat-value', [text(value)]),
    ...
    return Section(
      ...
      children: [
        div(classes: 'section-header', [
          p(classes: 'section-kicker', [
            text('I like to make things easy and fun'),
          ]),
          h3(classes: 'section-headline', [
            text('My '),
...
class _ResumeSection extends StatelessComponent {
    ...
    return Section(
      ...
      children: [
        div(classes: 'section-header', [
          ...
          p(classes: 'section-subheadline', [
            text('Practical '),
            span(classes: 'text-accent', [text('Mobile & Backend Dev ')]),
            text('Experience'),
          ]),
        ]),
        div(classes: 'resume-grid', [
          div(classes: 'resume-column', [
  ...
  Component _timelineItem({
    ...
    return div(classes: 'resume-item', [
...
class _ProjectsSection extends StatelessComponent {
      ...
      children: [
        ...
        div(classes: 'projects-grid', [
          ...
          _projectCard(
            ...
            techStack: const ['Flutter', 'Node.js', 'WebSockets'],
          ),
          _projectCard(
  ...
  Component _projectCard({
    ...
    return div(classes: 'project-showcase-card', [
      div(classes: 'project-image', [
        img(src: imagePaths.first, alt: title, classes: 'project-image-main'),
      ]),
      div(classes: 'project-body-area', [
        ...
        if (techStack.isNotEmpty)
          div(classes: 'project-tech-stack', [
            for (final tech in techStack)
              span(classes: 'tech-pill', [text(tech)]),
          ]),
        if (imagePaths.length > 1)
          div(classes: 'project-thumbs', [
            for (final path in imagePaths)
              img(src: path, alt: title, classes: 'project-thumb'),
          ]),
          ...
          div(classes: 'project-links', [
            ...
            if (githubLink != null)
              a(
                ...
                [
                  img(
                    src: 'assets/images/github-icon-1.svg',
                    classes: 'link-icon',
                    alt: 'GitHub',
                  ),
                  text('Frontend'),
...
class _ContactPill extends StatelessComponent {
  ...
  @override
  Component build(BuildContext context) {
    return li(classes: 'contact-pill', [
      span(classes: 'about-check', [text('✓')]),
      span([text(label)]),
    ]);
  }
